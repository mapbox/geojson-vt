...
test('clips polylines', function (t) {
    ...
    t.same(clipped, [
        ...
        {"geometry":[[40,10],[20,10],[20,20],[30,20],[30,30],[40,30]],"type":2,"tags":1},
        {"geometry":[[40,40],[25,40],[25,50],[10,50]],"type":2,"tags":1},
        {"geometry":[[10,60],[25,60]],"type":2,"tags":1},
        {"geometry":[[10,0],[40,0]],"type":2,"tags":2},
        {"geometry":[[40,10],[10,10]],"type":2,"tags":2}
    ]);
...
function closed(geometry) {
    return geometry.concat([geometry[0]]);
}
