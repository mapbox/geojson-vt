...
function intersectX(p0, p1, x) { return [x, (x - p0[0]) * (p1[1] - p0[1]) / (p1[0] - p0[0]) + p0[1]]; }
...
test('clips polylines', function (t) {
    ...
    var poly1 = {coords: coords1, type: 2, props: 1},
        poly2 = {coords: coords2, type: 2, props: 2};

    var clipped = clip([poly1, poly2], 10, 40, belowX, aboveX, intersectX);
...
test('clips polygons', function (t) {
    ...
    var poly1 = {coords: coords1, type: 3, props: 1},
        poly2 = {coords: coords2, type: 3, props: 2};
